...
export default function LandingComponent() {
  ...
  return (
    <div style={{ height: "100vh", width: "100%", position: "relative", backgroundColor: defaultColors.DEFAULT_BACKGROUND_COLOR }}>
      ...
      <div>
        <div style={{ height: "90vh", zIndex: 50 }} id="avatar-container"></div>
      </div>
    </div>
  )
}
